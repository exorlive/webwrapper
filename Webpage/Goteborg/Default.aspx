<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Webpage.Goteborg.Default" %>
...
<head runat="server">
	<meta charset="utf-8" />
	<title>ExorLive WebWrapper for Goteborg</title>
	...
	<header id="pageHeader">
		<nav class="navbar" role="navigation">
			...
			<ul class="nav navbar-nav" id="menu">
				<li class="active">
					<h1>ExorLive WebWrapper <%=GetLatestVersion()%> for Goteborg</h1>
				</li>
			</ul>
		</nav>
	</header>
