...
<body>
	<header id="pageHeader">
		<nav class="navbar" role="navigation">
			...
			<ul id="logedUser" class="list">
				<li class="item messages">
					<a href="#">
						<img src="images/message.svg" alt="" width="24" height="24" />
						<span class="sr-only">Send us feedback</span>
					</a>
				</li>
			</ul>
		</nav>
	...
	<div id="main">
		<div id="mainPage" class="container">
			...
			<ul>
				<li>
					<a href="<%=GetLatestDownload()%>">Latest version</a>
				</li>
			</ul>
