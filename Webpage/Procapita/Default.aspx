<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Webpage.Procapita.Default" %>
...
<head runat="server">
	<meta charset="utf-8" />
	<title>ExorLive WebWrapper for Procapita</title>
	...
	<header id="pageHeader">
		<nav class="navbar" role="navigation">
			...
			<ul class="nav navbar-nav" id="menu">
				<li class="active">
					<h1>ExorLive WebWrapper <%=GetLatestVersion()%> for Procapita</h1>
				</li>
			</ul>
		</nav>
	</header>
